...
namespace twentyfourhoursmedia\commentswork\widgets;

use twentyfourhoursmedia\commentswork\CommentsWork;
use twentyfourhoursmedia\commentswork\assetbundles\commentsworkwidgetwidget\CommentsWorkWidgetWidgetAsset;

use Craft;
use craft\base\Widget;

/**
 * Comments Work Widget
 *
 ...
 * @since     1.0.0
 */
class CommentsWorkWidget extends Widget
{
    ...
    {
        return Craft::t('comments-work', 'CommentsWorkWidget');
    }
    ...
    {
        return Craft::getAlias("@twentyfourhoursmedia/commentswork/assetbundles/commentsworkwidgetwidget/dist/img/CommentsWorkWidget-icon.svg");
    }
    ...
    {
        Craft::$app->getView()->registerAssetBundle(CommentsWorkWidgetWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'comments-work/_components/widgets/CommentsWorkWidget_body',
            [
