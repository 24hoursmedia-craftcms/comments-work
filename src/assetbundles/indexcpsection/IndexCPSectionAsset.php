...
namespace twentyfourhoursmedia\commentswork\assetbundles\indexcpsection;
...
class IndexCPSectionAsset extends AssetBundle
{
    ...
    public function init()
    {
        ...
        $this->sourcePath = "@twentyfourhoursmedia/commentswork/assetbundles/indexcpsection/dist";
