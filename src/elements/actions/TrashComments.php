...
class TrashComments extends ElementAction
{
    // Public Methods
    // =========================================================================
    ...
    {
        return Craft::t('comments-work', 'Trash…');
    }
    ...
    {
        return Craft::t('comments-work', 'Are you sure you want to trash the selected comment(s)?');
    }
    ...
    public function performAction(ElementQueryInterface $query): bool
    {
        ...
        $this->setMessage(Craft::t('comments-work', 'Comments trashed.'));
        return true;
    }
}
