...
class MakePendingComments extends ElementAction
{
    // Public Methods
    // =========================================================================
    ...
    {
        return Craft::t('comments-work', 'Make pending');
    }
    ...
    {
        return Craft::t('comments-work', 'Are you sure you want to mark the selected comment(s) as PENDING?');
    }
    ...
    public function performAction(ElementQueryInterface $query): bool
    {
        ...
        $this->setMessage(Craft::t('comments-work', 'Comments marked as pending.'));
        return true;
    }
}
